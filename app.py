...
def edit_artist_submission(artist_id):
    ...
    if not error:
        ...
        flash('An error occurred. Artist ' + new['name'] + ' could not be updated.')
        return redirect(url_for('index'))
...
def edit_venue(venue_id):
    ...
    if data.seeking_talent == 'true':
        s_talent = 'checked'
    elif data.seeking_talent == 'false':
        s_talent = ''
...
def edit_venue_submission(venue_id):
    ...
    try:
        ...
        current.facebook_link = new['facebook_link']
        current.website = new['website']
        current.seeking_venue = s_talent
        current.seeking_description = new['seeking_description']
    ...
    if not error:
        ...
        flash('An error occurred. Venue ' + new['name'] + ' could not be updated.')
        return redirect(url_for('index'))
